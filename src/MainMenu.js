    ...
    return (
        <div className="main-menu">
            <div className="main-menu-content">
                <h1 className="title">Erudite Trivia!</h1>
                <h4 className="description">
                    Test your trivia knowledge. Select your desired categories and question
                    preferences, then hit the start button. Do you have what it takes to become the
                ...
                <button className="main-menu--start-button" onClick={props.handleClick}>
                    Start quiz
                </button>
            </div>
        </div>
